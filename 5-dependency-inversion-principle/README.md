...
Dependency inversion principle is adhered to by passing dependencies into classes by interfaces rather than instantiation concrete implementations inside the classes.